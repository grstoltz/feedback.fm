...
const relationResolversInfo = {
  ...
  Song: ["owner", "comments"],
  Comment: ["approval", "sender", "receiver", "parent"],
...
const modelsInfo = {
  ...
  Comment: ["id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
...
const inputsInfo = {
  ...
  CommentWhereInput: ["AND", "OR", "NOT", "id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "approval", "sender", "receiver", "parent", "createdAt", "updatedAt"],
  CommentOrderByInput: ["id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
  CommentWhereUniqueInput: ["id"],
  CommentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
  ...
  CommentCreateInput: ["active", "body", "createdAt", "updatedAt", "approval", "sender", "receiver", "parent"],
  CommentUpdateInput: ["active", "body", "createdAt", "updatedAt", "approval", "sender", "receiver", "parent"],
  CommentCreateManyInput: ["id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
  CommentUpdateManyMutationInput: ["active", "body", "createdAt", "updatedAt"],
  ...
  ApprovalCreateInput: ["commentId", "status", "Comment"],
  ApprovalUpdateInput: ["commentId", "status", "Comment"],
  ...
  ApprovalCreateNestedOneWithoutCommentInput: ["create", "connectOrCreate", "connect"],
  ...
  ApprovalUpdateOneWithoutCommentInput: ["create", "connectOrCreate", "upsert", "connect", "disconnect", "delete", "update"],
  ...
  CommentCreateNestedOneWithoutApprovalInput: ["create", "connectOrCreate", "connect"],
  CommentUpdateOneWithoutApprovalInput: ["create", "connectOrCreate", "upsert", "connect", "disconnect", "delete", "update"],
  ...
  CommentCreateWithoutSenderInput: ["active", "body", "createdAt", "updatedAt", "approval", "receiver", "parent"],
  CommentCreateOrConnectWithoutSenderInput: ["where", "create"],
  CommentCreateManySenderInputEnvelope: ["data", "skipDuplicates"],
  CommentCreateWithoutReceiverInput: ["active", "body", "createdAt", "updatedAt", "approval", "sender", "parent"],
  ...
  CommentScalarWhereInput: ["AND", "OR", "NOT", "id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
  ...
  CommentCreateWithoutParentInput: ["active", "body", "createdAt", "updatedAt", "approval", "sender", "receiver"],
  ...
  ApprovalCreateWithoutCommentInput: ["commentId", "status"],
  ApprovalCreateOrConnectWithoutCommentInput: ["where", "create"],
  ...
  ApprovalUpsertWithoutCommentInput: ["update", "create"],
  ApprovalUpdateWithoutCommentInput: ["commentId", "status"],
  ...
  CommentCreateWithoutApprovalInput: ["active", "body", "createdAt", "updatedAt", "sender", "receiver", "parent"],
  CommentCreateOrConnectWithoutApprovalInput: ["where", "create"],
  CommentUpsertWithoutApprovalInput: ["update", "create"],
  CommentUpdateWithoutApprovalInput: ["active", "body", "createdAt", "updatedAt", "sender", "receiver", "parent"],
  SongCreateManyOwnerInput: ["id", "title", "mediaUrl", "mediaType", "genre", "createdAt", "updatedAt"],
  CommentCreateManySenderInput: ["id", "parentId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
  CommentCreateManyReceiverInput: ["id", "parentId", "senderId", "approvalId", "active", "body", "createdAt", "updatedAt"],
  ...
  CommentUpdateWithoutSenderInput: ["active", "body", "createdAt", "updatedAt", "approval", "receiver", "parent"],
  CommentUpdateWithoutReceiverInput: ["active", "body", "createdAt", "updatedAt", "approval", "sender", "parent"],
  ...
  CommentCreateManyParentInput: ["id", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
  CommentUpdateWithoutParentInput: ["active", "body", "createdAt", "updatedAt", "approval", "sender", "receiver"]
};
const outputsInfo = {
  ...
  CommentGroupBy: ["id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  CommentCountAggregate: ["id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt", "_all"],
  CommentAvgAggregate: ["id", "parentId", "senderId", "receiverId", "approvalId"],
  CommentSumAggregate: ["id", "parentId", "senderId", "receiverId", "approvalId"],
  CommentMinAggregate: ["id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
  CommentMaxAggregate: ["id", "parentId", "senderId", "receiverId", "approvalId", "active", "body", "createdAt", "updatedAt"],
